...
public class GroundSpawner : MonoBehaviour
{
    ...
    public void SpawnGround()
    {
        ...
        if (randomNum == 0)
        {
            ...
            {
                Instantiate(groundEnemy[0], new Vector3(transform.position.x + 8, -4.023341f, 0), Quaternion.identity); 
        ...
        if (randomNum == 1)
        {
            ...
            {
                Instantiate(groundEnemy[3], new Vector3(transform.position.x + 8, -1.68f, 0), Quaternion.identity);
            }
            else
            {
